...
{
    /// <inheritdoc />
    public partial class AddCoreReservationSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Events_DateRange", "[StartsAtUtc] < [EndsAtUtc]");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Seats_ColumnNumber", "[ColumnNumber] > 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ParkingReservations_FeeSnapshot", "[FeeSnapshot] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketPriceSnapshot = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ReservedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ReleasedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_BookingSeats_PriceSnapshot", "[TicketPriceSnapshot] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_CategoryId_StartsAtUtc",
                table: "Events",
                columns: new[] { "CategoryId", "StartsAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_VenueId_StartsAtUtc_EndsAtUtc",
                table: "Events",
                columns: new[] { "VenueId", "StartsAtUtc", "EndsAtUtc" });
